	...
	<div>
		...
		<article>
			...
			<p class="btp-light left50 width2">
                Baptiste Morizot, Manières d’être vivant. Enquêtes sur la vie à travers nous, éd. Actes Sud, collection Mondes Sauvages, février 2020.
			<br>
			p. 15-16
			</p>
		...
		<div class="align-center">
			...
			<div class="flex3">
				<div class="btp-regular width2">
                    ...
                    <p>
                    Si l’ancestralité animale, végétale, bactérienne est la forme que prend le trait sédimenté lorsqu’il est latent et replié dans un corps ; l’ascendance quant à elle est la forme dynamique que prend l’ancestralité quand elle remonte à la surface du présent pour se conjuguer avec d’autres, et donner le faciès si étrange et pourtant nécessaire, si élégant dans son bricolage, de chaque forme de vie, spécifique et individuelle(1). Le poète Novalis redécrit de manière libératrice ce que notre tradition nomme Nature. Il écrit : “J’appelle Nature cette communauté merveilleuse où nous introduit notre corps(2).” C’est de ce corps-là qu’il parle : épais de temps, tissé d’aliens familiers, bruissants d’ascendances disponibles. 
					</p>
                    <p>
                    (1)  Merci à Alain Damasio, avec qui cette nuance a été bricolée.</p>
                    <p>
                    (2)  Merci à Jean-Christophe Bailly, qui m’a introduit à la force de cette phrase.
                    </p>
		...
		<div class="align-center">
			<div class="flex3">
				<div class="btp-regular width2 left33">
                    ...
                    <p>
                    (1)  Cette formule a été élaborée par l’anthropologue Eduardo Viveiros de Castro pour qualifier l’ontologie perspectiviste : dans cette dernière, c’est votre position dans le champ des relations que vous entretenez avec les autres qui constitue votre identité la plus réelle, et pas votre “essence”, intrinsèque et indépendante. Voir Eduardo Viveiros de Castro, The Relative Native, Hau, Chicago, 2016, p. 258.
                    </p>		
				</div>
			</div>	
	...
	<article>
		<div class="align-center">
			...
			<div class="flex3">
				<div class="btp-regular width2">
					<p>
                    C’est cette circulation entre les pratiques de terrain et l’extraordinaire accès à l’information qui est permise par le web, notamment sous sa forme amateur, qui fonde un pistage philosophiquement enrichi susceptible de nous conférer des puissances exploratoires inouïes, pour nous apprendre à avoir des égards ajustés à chaque forme de vie, à chaque tissage de vivants. L’opposition répétée entre réalité authentique du contact avec la nature, d’un côté, et le monde “virtuel”, de l’autre, ne permet pas de comprendre la donne contemporaine : internet est une prodigieuse machine d’enrichissement des relations au vivant, dès lors qu’il fonctionne comme un opérateur de sensibilisation, immédiatement réinvesti dans les pratiques incarnées. D’où l’importance de défendre une culture de l’internet libre, riche de partages d’expériences et de savoirs multiples, accessibles, gratuits (c’est le librisme). Ce qui est réactivé dans ce partage d’informations qui enrichit nos connexions au vivant, c’est une “culture du don”, phénomène anthropologique réactivé par les communautés de hackers : imaginez un monde social dans lequel vous seriez valorisé non pas par ce que vous accaparez et possédez, mais pour ce que vous donnez librement.
                    </p>    
                    <p>
                    C’est en capturant ces pouvoirs de circulation des savoirs intelligents, par la culture du don caractéristique du Net, qu’on peut démocratiser l’exploration des égards ajustés envers le vivant. La sensibilité y est nourrie par les savoirs, elle en devient plus intense, plus vibratile, plus intelligente. Elle se connecte spontanément aux luttes : des citoyens deviennent par là experts des alliances écologiques avec les vivants sur les territoires qu’ils habitent et pour lesquels ils luttent, contre l’expertise des technocrates appointés par les firmes, ou au service des Grands Projets Inutiles qui les détruisent. 
					</p>			
				</div>
			</div>	
		</div>
