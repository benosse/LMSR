<template>
	<div>
		...
		<h1 class="width2 left33 gutter">
			<span class="underlined">Jardin punk</span>
		</h1>
		...
		<div class="align-top">
			<div class="flex4">
				<div class="width3 left25">
					<iframe
						width="100%"
						height="450"
						src="https://www.youtube.com/embed/B2lREA632qc"
					...
					<img src="/images/terre/jardinPunk/media1.gif" />

					<img src="/images/terre/jardinPunk/media2.png" />

					<video controls>
						<source
							src="/images/terre/jardinPunk/media3.mov"
							type="video/mp4"
						/>
			...
			<div class="flex2 gutter">
				<h1>
					une méthodologie de dialogue et de collaboration pluridisciplinaire
				</h1>
				<p class="btp-regular">
					<a href="">lien vers les pdf...</a>
				</p>
			</div>
		</div>
		...
		<!-- separation -->
		<img
			src="/images/misc/separator2.png"
			class="gutter separator width2 left66 flip"
		/>
		...
		<div class="align-top">
			<div class="flex3 gutter">
				<div class="width2 left33 gutter">
					<h1>
						une démarche de science citoyenne: ouverte, accessible, vulgarisée,
						reproductible par le grand public
					</h1>
					<p class="btp-regular">
						<a href="">lien vers les pdf...</a>
					</p>
			...
			<div class="flex3 gutter">
				<img src="/images/terre/jardinPunk/media4.gif" />
				<iframe
					src="/images/terre/jardinPunk/media5.pdf"
					width="100%"
					height="800px"
				></iframe>
			</div>
